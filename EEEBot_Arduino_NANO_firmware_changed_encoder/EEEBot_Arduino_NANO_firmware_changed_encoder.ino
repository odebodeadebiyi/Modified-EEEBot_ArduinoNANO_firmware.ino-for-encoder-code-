...
void requestEvent(void)
{
  ...
  Wire.write((byte)((enc2_count & 0x0000FF00) >> 8));    // first byte of x, containing bits 16 to 9
  Wire.write((byte)(enc2_count & 0x000000FF));           // second byte of x, containing the 8 LSB - bits 8 to 1
